...
\begin{tabularx}{\textwidth}{ X X X X }
  \class{6.828}{Operating Systems} & \class{6.172}{Performance Engineering} & \class{6.036}{Machine Learning} & \class{6.148}{Web Programming Comp.} \\
  \class{6.824}{Distributed Systems*} & \class{6.170}{Software Studio} & \class{6.034}{Artificial Intelligence} & \class{14.02}{Macroeconomics} \\
  \class{6.819}{Computer Vision} & \class{6.046}{Algorithm Design} & \class{6.033}{Computer Systems} & \class{14.01}{Microeconomics}
\end{tabularx}
}
...
Python, Java, Node.js, AngularJS, JavaScript, Rails, Flask, MongoDB, PHP, MySQL, CSS, C, C++, Git, {\fontfamily{cmr}\selectfont\LaTeX}
