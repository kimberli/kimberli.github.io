...
\begin{itemize}
\item[\e] Building data pipeline monitoring and visualization tooling on Risk Engineering team using Python
\item[\e] Adding semantic schematization in pipeline to improve data integrity
\end{itemize}
